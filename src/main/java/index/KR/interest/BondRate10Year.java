...
import static constants.Constant.BOND_10_YAR_EXCEL_TO_CSV_SUFFIX;
import static constants.Constant.BOND_10_YEAR_JSON_SUFFIX;
...
public class BondRate10Year implements Index {

  @Override
  public boolean convertToJson(String excelPath, String jsonDirPath) {
    String csvPath = jsonDirPath + "\\" + BOND_10_YAR_EXCEL_TO_CSV_SUFFIX + CSV_EXTENSION;
      ...
      try ( BufferedReader br = Files.newBufferedReader(inputCsv) ) {
        ...
        for( Map.Entry<Integer, List<BondDto>> entry : yearMap.entrySet() ){
          ...
          Path outputFile = outputDir.resolve(
              year + BOND_10_YEAR_JSON_SUFFIX + JSON_EXTENSION
          );
